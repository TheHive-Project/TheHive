...
class AttachmentCtrlTest extends PlaySpecification with Mockito {
  ...
  def specs(name: String, app: AppBuilder): Fragment = {
    ...
    "download a simple attachment from his id" in {
      ...
      header("Content-Disposition", result) must beSome.which(h => h shouldEqual "attachment; filename=\"a4bf1f6be616bf6a0de2ff6264de43a64bb768d38c783ec2bc74b5d4dcf5f889\"")
    }
  }
}
