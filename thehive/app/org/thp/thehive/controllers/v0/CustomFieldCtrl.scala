...
import org.thp.thehive.services.{CustomFieldSrv, SearchSrv}
...
class PublicCustomField(customFieldSrv: CustomFieldSrv, searchSrv: SearchSrv) extends PublicData with TraversalOps {
